  ...
  <div>
    <v-card class="search_bar">
      <v-row class="ma-0">
        ...
        <v-col class="pa-0 pr-0 ma-0 pl-3">
          <v-text-field class="pt-0"
            v-model="search" clearable height="20px" rounded
            hide-details placeholder="검색어를 입력하세요."
          ></v-text-field>
        </v-col>
      <v-btn class="pl-7" icon><v-icon color="white" small dark>mdi-magnify</v-icon></v-btn>
      </v-row>
    </v-card>
  </div>
</template>
